...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference("Drink.count") do
      post drinks_url, params: { drink: { abv: @drink.abv, company: @drink.company, flavors: @drink.flavors, name: @drink.name } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { abv: @drink.abv, company: @drink.company, flavors: @drink.flavors, name: @drink.name } }
